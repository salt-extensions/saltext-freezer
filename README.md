# Salt Extension for Freezer

Salt Extension for interacting with Freezer
...
The saltext-freezer project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-freezer.git
...
* Writing blog posts
* Sharing your experiences using Salt + Freezer
  on social media
...
[issues]: https://github.com/salt-extensions/saltext-freezer/issues
[PRs]: https://github.com/salt-extensions/saltext-freezer/pulls
[discussions]: https://github.com/salt-extensions/saltext-freezer/discussions
